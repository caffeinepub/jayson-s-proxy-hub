...
export class Backend implements backendInterface {
    ...
    async addMeme(arg0: Meme): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addMeme(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getMemes(): Promise<Array<Meme>> {
        if (this.processError) {
            try {
                const result = await this.actor.getMemes();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async setPassword(arg0: string, arg1: string): Promise<boolean> {
        if (this.processError) {
            try {
